...
import changePasswordService from '../services/auth/changepaswordservice';
...
const ChangePassword: React.FC<Props> = ({ navigation }) => {
  ...
  const handleSavePassword = async () => {
    ...
    try {
      ...
      const res = await changePasswordService.changePassword(payload);
      console.log('[ChangePassword] API response:', res);
      console.log('[ChangePassword] Success: Password updated on server and local database');
      navigation.goBack();
    } catch (e: any) {
      console.log('[ChangePassword] API error:', e?.response?.data || e?.message);
